        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-6 flex flex-col items-center gap-6">
            <div className="flex items-center gap-3 w-full">
              <a
                href="https://github.com/gabspiewak/the-delegation"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2.5 px-6 py-3.5 bg-darkDelegation text-white rounded-xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-black transition-all active:scale-95 cursor-pointer shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2.5 px-6 py-3.5 bg-zinc-100 text-zinc-600 rounded-xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-zinc-200 transition-all active:scale-95 cursor-pointer shadow-sm"
              >
                <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
                  <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z" />
                </svg>
            ...
            <div className="pt-4 border-t border-zinc-50 w-full space-y-2">
              <p className="text-[10px] font-bold text-zinc-700 uppercase tracking-[0.15em] text-center">
                Fork by <a href="https://github.com/gabspiewak" target="_blank" rel="noopener noreferrer" className="hover:text-darkDelegation transition-colors underline decoration-zinc-200 underline-offset-4">Gabin Spiewak</a>
              </p>
              <p className="text-[10px] text-zinc-400 tracking-[0.1em] text-center leading-loose">
                Original concept, 3D engine & assets by{' '}
                <a href="https://unboring.net" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-darkDelegation transition-colors underline decoration-zinc-100 underline-offset-4">
