          ...
          <div className="flex justify-between items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {finalAssetType === 'text' && (
                <>
                  <button
                    onClick={() => exportToWord(finalOutput || '')}
                    className="flex items-center gap-1.5 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] active:scale-[0.98] transition-all shadow-lg shadow-blue-900/10"
                  ...
                  <button
                    onClick={() => exportToExcel(finalOutput || '').catch(console.error)}
                    className="flex items-center gap-1.5 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] active:scale-[0.98] transition-all shadow-lg shadow-emerald-900/10"
