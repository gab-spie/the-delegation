...
const Header: React.FC = () => {
  ...
  const hasKey = !!(llmConfig.claudeApiKey || llmConfig.geminiApiKey);
      ...
      <div className="flex items-center min-w-0">
        ...
        <div className="flex items-center gap-3 self-start mt-3 ml-2 min-w-0">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <a
              href="https://github.com/gabspiewak"
              target="_blank"
              rel="noopener"
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="text-[10px] font-medium text-zinc-300 hover:text-darkDelegation transition-colors truncate"
